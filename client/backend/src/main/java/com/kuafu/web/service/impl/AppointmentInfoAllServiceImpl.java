...
import com.kuafu.web.mapper.AppointmentInfoAllMapper;
 ...
 */
@Slf4j
@Service("AppointmentInfoAll")
public class AppointmentInfoAllServiceImpl extends ServiceImpl<AppointmentInfoAllMapper, AppointmentInfoAll> implements IAppointmentInfoAllService {
@Autowired
private AppointmentInfoAllMapper taskInfoAllMapper;


@Override
public List<AppointmentInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AppointmentInfoAll> queryWrapper) {

        LambdaQueryWrapper<AppointmentInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<AppointmentInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<AppointmentInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<AppointmentInfoAll> queryWrapper) {
        LambdaQueryWrapper<AppointmentInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<AppointmentInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<AppointmentInfoAll> queryWrapper) {
