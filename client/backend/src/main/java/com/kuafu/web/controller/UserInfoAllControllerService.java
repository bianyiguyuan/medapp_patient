...
@Autowired
    ...
    public BaseResponse page( UserInfoAllPageVO pageVO){
                ...
                queryWrapper.and(wrapper -> {
                    for (int i = 0; i < strings.length; i++) {
                        ...
                        if (StringUtils.isNotEmpty(s)) {
                            ...
                            wrapper.like(UserInfoAll::getLevelName, trim);
        ...
        if(StringUtils.isNotEmpty(pageVO.getDescription())) {
                queryWrapper.like(UserInfoAll::getDescription, pageVO.getDescription());
            }
        ...
        if(StringUtils.isNotEmpty(pageVO.getEmail())) {
                queryWrapper.like(UserInfoAll::getEmail, pageVO.getEmail());
            }
