...
import com.kuafu.web.mapper.CouponInfoAllMapper;
 ...
 */
@Slf4j
@Service("CouponInfoAll")
public class CouponInfoAllServiceImpl extends ServiceImpl<CouponInfoAllMapper, CouponInfoAll> implements ICouponInfoAllService {
@Autowired
private CouponInfoAllMapper taskInfoAllMapper;


@Override
public List<CouponInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CouponInfoAll> queryWrapper) {

        LambdaQueryWrapper<CouponInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<CouponInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<CouponInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<CouponInfoAll> queryWrapper) {
        LambdaQueryWrapper<CouponInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<CouponInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<CouponInfoAll> queryWrapper) {
