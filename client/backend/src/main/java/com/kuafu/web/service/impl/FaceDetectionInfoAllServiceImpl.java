...
import com.kuafu.web.mapper.FaceDetectionInfoAllMapper;
 ...
 */
@Slf4j
@Service("FaceDetectionInfoAll")
public class FaceDetectionInfoAllServiceImpl extends ServiceImpl<FaceDetectionInfoAllMapper, FaceDetectionInfoAll> implements IFaceDetectionInfoAllService {
@Autowired
private FaceDetectionInfoAllMapper taskInfoAllMapper;


@Override
public List<FaceDetectionInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<FaceDetectionInfoAll> queryWrapper) {

        LambdaQueryWrapper<FaceDetectionInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
  ...
  @Override
public List<FaceDetectionInfoAll> selectListNew(PageRequest pageRequest, LambdaQueryWrapper<FaceDetectionInfoAll> queryWrapper,boolean isPage) {
...
@Override
public long selectCount(PageRequest pageRequest, LambdaQueryWrapper<FaceDetectionInfoAll> queryWrapper) {
        LambdaQueryWrapper<FaceDetectionInfoAll> pageQueryWrapper = getPageQueryWrapper(pageRequest, queryWrapper);
...
@Override
public IPage pageNew(IPage<FaceDetectionInfoAll> page, PageRequest pageRequest, LambdaQueryWrapper<FaceDetectionInfoAll> queryWrapper) {
